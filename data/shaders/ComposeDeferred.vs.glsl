...
vec3 CalculateSkyRay(vec2 uv, float fieldOfView, float aspectRatio) {
...
void main() {
    ...
    v_sky_ray = mat3(inverse(u_global_uniforms.ViewMatrix)) * CalculateSkyRay(uv, u_global_uniforms.CameraPosition.w, u_global_uniforms.CameraDirection.w);
}
